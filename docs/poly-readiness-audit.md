...
- A directed cycle-budget model exists for the few-cycle `PSWITCH`/`PCALL`
  target and the current RTL technology-maps to Xilinx 7-series cells, but no
  place-and-route timing/timing-closure proof exists.
