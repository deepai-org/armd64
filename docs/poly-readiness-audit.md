...
| Frontend fetch-to-retire prototype | `rtl/poly_frontend_memory_retire.sv` feeds `rtl/poly_frontend_fetch_decode_pipeline.sv` into `rtl/poly_frontend_retire.sv`, connecting x86/raw fetch issue, response wait/fault handling, fetched instruction words, and retire/commit/fault outputs. |
