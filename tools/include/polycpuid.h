...
enum {
  ...
  POLY_TRAP_IMPORT = 3,
  POLY_TRAP_ILLEGAL = 4,
  POLY_SPILL_REASON_NONE = 0,
  POLY_SPILL_REASON_INTERRUPT = 1,
  ...
  POLY_X86_OPCODE_CONTRACT_VERSION = 1,
  POLY_X86_OPCODE_FAMILY_VENDOR_PROTOTYPE = 1,
  POLY_X86_OPCODE_FLAG_CPUID_DISCOVERED = (1U << 0),
  POLY_X86_OPCODE_FLAG_DEDICATED_DECODE = (1U << 1),
  POLY_X86_OPCODE_FLAG_FIXED_LENGTH = (1U << 2),
  POLY_X86_OPCODE_FLAG_NOT_UD_TRAP = (1U << 3),
  POLY_X86_OPCODE_FLAG_VENDOR_PROTOTYPE = (1U << 4),
  POLY_X86_OPCODE_FLAG_PRODUCTION_REASSIGNABLE = (1U << 5),
  ...
  POLY_CPUID_V2_IMPLEMENTED_FEATURES = (1U << 0) | (1U << 1) | (1U << 2) | (1U << 3) | (1U << 4) | (1U << 5),
  POLY_CPUID_V2_REQUIRED_FEATURES = (1U << 0) | (1U << 1) | (1U << 5),
  POLY_V2_MEM_PROBE_FLAG_READ = (1U << 0),
  POLY_V2_MEM_PROBE_FLAG_WRITE = (1U << 1),
  POLY_V2_MEM_PROBE_FLAG_EXECUTE = (1U << 2),
  POLY_V2_MEM_PROBE_FLAGS_SUPPORTED = (1U << 0) | (1U << 1) | (1U << 2),
  POLY_V2_MEM_PROBE_RESULT_CANONICAL = (1ULL << 0),
  POLY_V2_MEM_PROBE_RESULT_PRESENT = (1ULL << 1),
  POLY_V2_MEM_PROBE_RESULT_READABLE = (1ULL << 2),
  POLY_V2_MEM_PROBE_RESULT_WRITABLE = (1ULL << 3),
  POLY_V2_MEM_PROBE_RESULT_EXECUTABLE = (1ULL << 4),
  POLY_V2_MEM_PROBE_RESULT_CROSSES_PAGE = (1ULL << 5),
  POLY_V2_MEM_PROBE_RESULT_PAGE_ALIGNED = (1ULL << 6),
  POLY_V2_MEM_PROBE_RESULT_FAILURE_UNMAPPED = (1ULL << 16),
  POLY_V2_MEM_PROBE_RESULT_FAILURE_PERMISSION = (1ULL << 17),
  POLY_V2_MEM_PROBE_RESULT_FAILURE_NONCANONICAL = (1ULL << 18),
  POLY_V2_MEM_PROBE_RESULT_FAILURE_OVERFLOW = (1ULL << 19),
  POLY_V2_MEM_PROBE_RESULT_FAILURE_UNSUPPORTED = (1ULL << 20),
  ...
  POLY_STATE_XSAVE_FLAG_USER_SPILL = (1U << 14),
  POLY_STATE_XSAVE_FLAG_MONITOR_TRAMPOLINE = (1U << 15),
  POLY_STATE_XSAVE_FLAG_OS_XSAVE_NOT_REQUIRED = (1U << 16),
...
static inline struct poly_cpuid_regs poly_cpuid_expected_escape_leaf33(void) {
  struct poly_cpuid_regs regs;
  regs.eax = POLY_X86_OPCODE_CONTRACT_VERSION;
  regs.ebx = POLY_X86_OPCODE_FLAG_CPUID_DISCOVERED |
  ...
  regs.ecx = POLY_X86_OPCODE_FAMILY_VENDOR_PROTOTYPE;
  regs.edx = 0;
  return regs;
}
...
static inline struct poly_cpuid_regs poly_cpuid_expected_arch_state_leaf(void) {
  ...
  regs.edx = POLY_STATE_XSAVE_FLAG_INTERRUPT_RESUME |
