...
int main(void) {
  ...
  if (poly_abi_signature_set(POLY_ABI_SIGNATURE_SLOT_COUNT,
      ...
      poly_abi_signature_set(3,
        POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_FP32 + 1) != POLY_ERR_INVAL ||
