...
static const struct poly_layout_row poly_layout_rows[] = {
  ...
  POLY_LAYOUT_ROW(event_record, POLY_STATE_XSAVE_EVENT_RECORD_OFFSET,
    POLY_STATE_XSAVE_EVENT_RECORD_BYTES),
  POLY_LAYOUT_ROW(event_args, POLY_STATE_XSAVE_EVENT_ARGS_OFFSET,
    POLY_STATE_XSAVE_EVENT_ARGS_BYTES),
