...
enum {
  ...
  POLY_AARCH64_BRK_RISCV_CALL_VEC128_U32 = 0x7ff8,
  ...
  POLY_RISCV_AARCH64_CALL_VEC128_U32 = 0x0000507b,
...
static inline struct poly_cpuid_regs poly_cpuid_expected_escape_leaf3(void) {
  ...
  regs.ecx = POLY_AARCH64_BRK_RISCV_CALL_VEC128_U32;
  regs.edx = POLY_RISCV_AARCH64_CALL_VEC128_U32;
  return regs;
}
