...
case "$path" in
  ...
  */aarch64-process-needed-ifunc-real.elf) expected=42; process_mode=1 ;;
  ...
  */aarch64-process-cross-x86-fpairarg-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-cross-x86-fpairret-real.elf) expected=42; process_mode=1 ;;
  ...
  */aarch64-process-cross-fp32-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-cross-fpairarg-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-cross-fpairret-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-cross-sret-real.elf) expected=42; process_mode=1 ;;
  ...
  */aarch64-process-tls-default-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-tls-default-needed-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-tls-trad-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-tls-trad-needed-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-copy-reloc-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-needed-root-export-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-needed-root-ifunc-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-weak-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-weak-needed-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-versioned-needed-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-soname-once-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-init-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-preinit-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-init-needed-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-dt-init-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-dt-init-needed-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-fini-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-fini-exit-group-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-fini-order-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-dt-fini-real.elf) expected=42; process_mode=1 ;;
  */aarch64-process-fini-needed-real.elf) expected=42; process_mode=1 ;;
  ...
  */aarch64-strlen.elf) expected=0x4c000101 ;;
  */aarch64-memfill.elf) expected=0x4c000102 ;;
  */aarch64-memcmp.elf) expected=0x4c000103 ;;
  */aarch64-memcpy.elf) expected=0x4c000104 ;;
  ...
  */aarch64-pcall-getauxval-real.so) expected=10579; entry="#poly_entry"; runner="polycall" ;;
  ...
  */aarch64-pcall-snprintf-fp-real.so) expected=1155; entry="#poly_entry"; runner="polycall" ;;
  ...
  */aarch64-pcall-cross-fp64-real.so) expected=0x4026800000000000; entry="#poly_entry"; runner="polycall" ;;
  ...
  */riscv-compressed-frame.elf) expected=42 ;;
  ...
  */riscv-process-needed-ifunc-real.elf) expected=42; process_mode=1 ;;
  ...
  */riscv-process-cross-x86-fpairarg-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-cross-x86-fpairret-real.elf) expected=42; process_mode=1 ;;
  ...
  */riscv-process-cross-fp32-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-cross-fpairarg-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-cross-fpairret-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-cross-sret-real.elf) expected=42; process_mode=1 ;;
  ...
  */riscv-process-tls-default-real.elf) expected=42; process_mode=1 ;;
  ...
  */riscv-process-needed-root-export-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-needed-root-ifunc-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-weak-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-weak-needed-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-versioned-needed-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-soname-once-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-init-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-preinit-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-init-needed-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-dt-init-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-dt-init-needed-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-fini-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-fini-exit-group-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-fini-order-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-dt-fini-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-fini-needed-real.elf) expected=42; process_mode=1 ;;
  */riscv-process-dt-fini-needed-real.elf) expected=42; process_mode=1 ;;
  ...
  */riscv-strlen.elf) expected=0x4c000201 ;;
  */riscv-memfill.elf) expected=0x4c000202 ;;
  */riscv-memcmp.elf) expected=0x4c000203 ;;
  */riscv-memcpy.elf) expected=0x4c000204 ;;
  ...
  */riscv-compressed-ebreak.elf) expected=0x4c000205 ;;
  ...
  */riscv-pcall-getauxval-real.so) expected=12669; entry="#poly_entry"; runner="polycall" ;;
  ...
  */riscv-pcall-snprintf-fp-real.so) expected=1155; entry="#poly_entry"; runner="polycall" ;;
  ...
  */riscv-pcall-cross-fp64-real.so) expected=0x4026800000000000; entry="#poly_entry"; runner="polycall" ;;
