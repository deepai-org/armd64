...
case "$path" in
  ...
  */aarch64-pcall-snprintf-fp-real.so) expected=851; entry="#poly_entry"; runner="polycall" ;;
  ...
  */riscv-pcall-snprintf-fp-real.so) expected=851; entry="#poly_entry"; runner="polycall" ;;
