...
case "$path" in
  ...
  */aarch64-pcall-getauxval-real.so) expected=4141; entry="#poly_entry"; runner="polycall" ;;
  ...
  */riscv-pcall-getauxval-real.so) expected=4141; entry="#poly_entry"; runner="polycall" ;;
