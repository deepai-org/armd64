...
case "$path" in
  ...
  */aarch64-pcall-getauxval-real.so) expected=6579; entry="#poly_entry"; runner="polycall" ;;
  ...
  */riscv-pcall-getauxval-real.so) expected=8669; entry="#poly_entry"; runner="polycall" ;;
