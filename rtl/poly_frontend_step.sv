...
//
// This composes fetch/decode dispatch and frontend handoff validation. Memory
// fetch and full ISA execution are still separate blocks; this module only
// plans instruction width, control transitions, and pre-commit transition
// faults for one already-fetched word.
module poly_frontend_step (
  ...
  poly_frontend_decode_dispatch decode_dispatch (
    ...
    .insn_o(insn_o),
    .fallthrough_pc_o(fallthrough_pc),
