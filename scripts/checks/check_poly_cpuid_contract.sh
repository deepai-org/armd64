...
compare_const BX_POLY_X86_CTRL_COMPLETE_EVENT POLY_X86_CTRL_COMPLETE_EVENT
compare_const BX_POLY_X86_CTRL_FENCE POLY_X86_CTRL_FENCE
compare_const BX_POLY_X86_CTRL_MONITOR_ENTRY_SET POLY_X86_CTRL_MONITOR_ENTRY_SET
...
compare_const BX_POLY_V2_COMPLETE_DESC_BYTES POLY_V2_COMPLETE_DESC_BYTES
compare_const BX_POLY_V2_COMPLETE_DESC_ALIGN POLY_V2_COMPLETE_DESC_ALIGN
compare_const BX_POLY_V2_COMPLETE_DESC_HEADER_BYTES POLY_V2_COMPLETE_DESC_HEADER_BYTES
compare_const BX_POLY_V2_COMPLETE_FLAGS_SUPPORTED POLY_V2_COMPLETE_FLAGS_SUPPORTED
...
assert_not_contains "POLY_EVENT_RECORD_FLAG_MONITOR_MEMORY" "$HEADER" \
...
assert_not_contains "BX_POLY_EVENT_RECORD_FLAG_MONITOR_MEMORY[[:space:]]*\\|" "$BOCHS_CPU" \
  "Bochs CPUID event-record leaf must not advertise retired monitor-packet trap flags"
...
compare_const BX_POLY_STATE_XSAVE_EVENT_RECORD_OFFSET POLY_STATE_XSAVE_EVENT_RECORD_OFFSET
compare_const BX_POLY_STATE_XSAVE_EVENT_ARGS_OFFSET POLY_STATE_XSAVE_EVENT_ARGS_OFFSET
...
compare_const BX_POLY_EVENT_RECORD_LAYOUT_VERSION POLY_EVENT_RECORD_LAYOUT_VERSION
compare_const BX_POLY_EVENT_RECORD_HEADER_BYTES POLY_EVENT_RECORD_HEADER_BYTES
assert_not_contains "\\bPOLY_EVENT_RECORD_ARG_COUNT\\b" "$HEADER" \
...
compare_const BX_POLY_EVENT_RECORD_FLAG_VECTOR_DELIVERY POLY_EVENT_RECORD_FLAG_VECTOR_DELIVERY
compare_const BX_POLY_EVENT_RECORD_FLAG_NO_VECTOR_X86_EXCEPTIONS POLY_EVENT_RECORD_FLAG_NO_VECTOR_X86_EXCEPTIONS
compare_const BX_POLY_EVENT_RECORD_FLAG_TRAP_RETURN_RESTORE POLY_EVENT_RECORD_FLAG_TRAP_RETURN_RESTORE
compare_const BX_POLY_EVENT_RECORD_FLAG_ALL_FRONTEND_HANDLERS POLY_EVENT_RECORD_FLAG_ALL_FRONTEND_HANDLERS
