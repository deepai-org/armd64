...
if [ "$RUN_POLY_CALL" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-pcall-cross-needed-real.so#poly_entry=428 \
    depfini:/usr/lib/polyapps/aarch64-pcall-cross-needed-real.so#poly_entry=52 \
    /usr/lib/polyapps/aarch64-pcall-cross-needed-transitive-real.so#poly_entry=825 \
    ...
    /usr/lib/polyapps/riscv-pcall-cross-needed-real.so#poly_entry=428 \
    depfini:/usr/lib/polyapps/riscv-pcall-cross-needed-real.so#poly_entry=52 \
    /usr/lib/polyapps/riscv-pcall-cross-needed-transitive-real.so#poly_entry=825 \
