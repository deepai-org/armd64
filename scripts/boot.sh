...
POLYCALL_CROSS_IFUNC_FP32_DEP_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_ifunc_fp32_dep_real.c"
POLYCALL_CROSS_IFUNC_FP32_MAIN_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_ifunc_fp32_main_real.c"
...
POLYCALL_CROSS_IFUNC_FP32_ROOT_DEP_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_ifunc_fp32_root_dep_real.c"
POLYCALL_CROSS_IFUNC_FP32_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_ifunc_fp32_root_main_real.c"
...
POLYCALL_CROSS_FP64_DEP_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_fp64_dep_real.c"
POLYCALL_CROSS_FP64_MAIN_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_fp64_main_real.c"
POLYCALL_CROSS_FP32_DEP_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_fp32_dep_real.c"
POLYCALL_CROSS_FP32_MAIN_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_cross_fp32_main_real.c"
...
POLYCALL_AARCH64_CRC_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_aarch64_crc_real.c"
POLYCALL_AARCH64_AES_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_aarch64_aes_real.c"
POLYCALL_AARCH64_PMULL_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_aarch64_pmull_real.c"
POLYCALL_AARCH64_SHA_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_aarch64_sha_real.c"
...
POLYCALL_AARCH64_SIMD_MINMAX_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_aarch64_simd_minmax_real.c"
POLYCALL_AARCH64_SIMD_ABSDIFF_REAL_SRC="$ROOT_DIR/tools/fixtures/polycall/polycall_aarch64_simd_absdiff_real.c"
...
POLY_ALPINE_POSTGRES_SETUP_TIMEOUT="${POLY_ALPINE_POSTGRES_SETUP_TIMEOUT:-600}"
...
if [[ -z "${POLY_ALPINE_POSTGRES_PREFAULT_GUEST_MMAPS+x}" ]]; then
  POLY_ALPINE_POSTGRES_PREFAULT_GUEST_MMAPS=0
  if [[ "$RUN_POLY_ALPINE_POSTGRES_SMOKE" == "1" ]]; then
    POLY_ALPINE_POSTGRES_PREFAULT_GUEST_MMAPS=1
  fi
fi
...
build_poly_elf_payloads() {
  ...
  mkdir -p "$TMP_DIR/poly-link/x86_64"
  ...
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PREEMPT_STRESS_REAL_SRC" \
  ...
  aarch64-linux-gnu-gcc -O2 -static -s -fno-stack-protector \
    "$POLYEXEC_JIT_SELFMOD_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-jit-selfmod-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_DEP \
    -Wl,-soname,libpolyprocesscrossneeded-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossneeded-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEP \
    -Wl,-soname,libpolyprocesstls-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesstls-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEFAULT_DEP \
    -Wl,-soname,libpolyprocesstlsdefault-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesstlsdefault-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_DEP \
    -Wl,-soname,libpolyprocesscrossneeded-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossneeded-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_DEP \
    -Wl,-soname,libpolyprocesscrossneeded-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossneeded-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfp64-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfp64-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfp32-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA32_DEP \
    -Wl,-soname,libpolyprocesscrosshfa32-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosshfa32-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA64_DEP \
    -Wl,-soname,libpolyprocesscrosshfa64-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosshfa64-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA32_ARG_DEP \
    -Wl,-soname,libpolyprocesscrosshfa32arg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosshfa32arg-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA64_ARG_DEP \
    -Wl,-soname,libpolyprocesscrosshfa64arg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosshfa64arg-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfpairarg-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfpairarg-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfpairret-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfpairret-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosssret-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosssret-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossfp32-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfp64-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfp32-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfpairarg-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfpairret-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossvec-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossvec-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossvec-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosscompact-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrosscompact-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosscompact-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossstack9-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesscrossstack9-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossstack9-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosssret-x86_64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_IFUNC_DEP \
    -Wl,-soname,libpolyprocessifuncneeded-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessifuncneeded-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_IFUNC_DEP \
    -Wl,-soname,libpolyprocessifuncneeded-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessifuncneeded-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_MID \
    -Wl,-soname,libpolyprocessneededmid-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none -Wl,--unresolved-symbols=ignore-all \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessneededmid-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_MID \
  ...
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_VERSIONED_DEP \
    -Wl,-soname,libpolyprocessversioned-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    -Wl,--version-script="$POLYEXEC_PROCESS_VERSIONED_DEP_REAL_MAP" \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessversioned-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_VERSIONED_DEP \
    ...
    -Wl,--version-script="$POLYEXEC_PROCESS_VERSIONED_DEP_REAL_MAP" \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessversioned-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_WEAK_DEP \
    -Wl,-soname,libpolyprocessweak-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessweak-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_WEAK_DEP \
    -Wl,-soname,libpolyprocessweak-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocessweak-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEP \
    -Wl,-soname,libpolyprocesstls-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesstls-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEP \
    -Wl,-soname,libpolyprocesstls-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesstls-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEFAULT_DEP \
    -Wl,-soname,libpolyprocesstlsdefault-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesstlsdefault-aarch64.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEFAULT_DEP \
    -Wl,-soname,libpolyprocesstlsdefault-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesstlsdefault-riscv.so"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_TRAD_DEP \
    -Wl,-soname,libpolyprocesstlstrad-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/x86_64/libpolyprocesstlstrad-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_DEP \
    -Wl,-soname,libpolyprocesscrossneeded-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossneeded-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_TLS_DEP \
    -Wl,-soname,libpolyprocesstls-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesstls-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_TLS_DEFAULT_DEP \
    -Wl,-soname,libpolyprocesstlsdefault-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesstlsdefault-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfp64-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfp64-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_NATIVE_SRET_DEP \
    -Wl,-soname,libpolyprocesscrossnativesret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossnativesret-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfp64-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfpairarg-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfpairret-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrosssret-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfp32-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_HFA32_DEP \
    -Wl,-soname,libpolyprocesscrosshfa32-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosshfa32-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_HFA64_DEP \
    -Wl,-soname,libpolyprocesscrosshfa64-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosshfa64-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_HFA32_ARG_DEP \
    -Wl,-soname,libpolyprocesscrosshfa32arg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosshfa32arg-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_HFA64_ARG_DEP \
    -Wl,-soname,libpolyprocesscrosshfa64arg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosshfa64arg-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfpairarg-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfpairret-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosssret-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_NATIVE_SRET_DEP \
    -Wl,-soname,libpolyprocesscrossnativesret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossnativesret-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfp32-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfpairarg-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfpairret-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfpairarg-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfpairret-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosssret-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_NATIVE_SRET_DEP \
    -Wl,-soname,libpolyprocesscrossnativesret-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossnativesret-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossfp32-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossvec-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossvec-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossvec-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosscompact-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrosscompact-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrosscompact-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossstack9-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossstack9-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolyprocesscrossstack9-x86_64.so"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
  ...
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    ...
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossneeded-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-needed-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_STACK9_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossstack9-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-stack9-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP64_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp64-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-fp64-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp32-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-fp32-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairarg-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_RET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairret-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_SRET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosssret-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-sret-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_VEC128_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossvec-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-vec128-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_COMPACT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosscompact-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-compact-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_TLS_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesstls-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-tls-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_TLS_DEFAULT_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesstlsdefault-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-x86-tls-default-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-needed-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossneeded-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-needed-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP64_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp64-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-fp64-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP64_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp64-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-fp64-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp32-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-fp32-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosshfa32-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA64_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosshfa64-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA32_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosshfa32arg-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32arg-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_HFA64_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosshfa64arg-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64arg-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairarg-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairarg-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairarg-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-fpairarg-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_RET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairret-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairret-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FPAIR_RET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairret-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-fpairret-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_SRET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosssret-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-sret-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_SRET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosssret-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-sret-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_FP32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp32-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-fp32-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_VEC128_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossvec-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-vec128-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_VEC128_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossvec-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-vec128-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_COMPACT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosscompact-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-compact-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_COMPACT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosscompact-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-compact-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_STACK9_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossstack9-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-stack9-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_STACK9_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossstack9-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-stack9-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_IFUNC_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocessifuncneeded-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-ifunc-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_IFUNC_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-ifunc-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_TRANSITIVE_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none -Wl,--allow-shlib-undefined \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocessneededmid-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-transitive-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_TRANSITIVE_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none -Wl,--allow-shlib-undefined \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-transitive-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_INDIRECT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none -Wl,--allow-shlib-undefined \
    -Wl,--unresolved-symbols=ignore-all \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocessneededmid-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-indirect-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_NEEDED_INDIRECT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none -Wl,--allow-shlib-undefined \
    -Wl,--unresolved-symbols=ignore-all \
  ...
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_VERSIONED_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocessversioned-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-versioned-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_VERSIONED_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-versioned-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_WEAK_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocessweak-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-weak-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_WEAK_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-weak-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesstls-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-tls-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEFAULT_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesstlsdefault-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-default-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_DEFAULT_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    ...
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-riscv-tls-default-real.elf"
  x86_64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -fno-stack-protector -DPOLY_PROCESS_TLS_TRAD_DEP_MAIN \
    -Wl,-e,_start -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/x86_64" \
    -Wl,--no-as-needed -l:libpolyprocesstlstrad-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-trad-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
  ...
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    ...
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp64-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-fp64-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FP32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp32-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-fp32-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairarg-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-fpairarg-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_FPAIR_RET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairret-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-fpairret-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_SRET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossnativesret-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-sret-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_VEC128_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossvec-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-vec128-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_COMPACT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrosscompact-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-compact-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -DPOLY_PROCESS_NEEDED_STACK9_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolyprocesscrossstack9-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-process-cross-stack9-real.elf"
  aarch64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossfp64-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP64_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossfp64-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossfp32-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossfp32-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossifuncfp32-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossifuncfp32-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossrootifuncfp32-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_ROOT_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossrootifuncfp32-aarch64.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossfp64-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP64_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolycrossfp64-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossfp32-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolycrossfp32-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossifuncfp32-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolycrossifuncfp32-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-soname,libpolycrossrootifuncfp32-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_ROOT_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/aarch64/libpolycrossrootifuncfp32-riscv.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP64_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolycrossfp64-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-cross-fp64-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP32_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolycrossfp32-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-cross-fp32-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolycrossifuncfp32-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-cross-ifunc-fp32-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_ROOT_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/aarch64" \
    -Wl,--no-as-needed -l:libpolycrossrootifuncfp32-riscv.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-cross-root-ifunc-fp32-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8-a+crc \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_CRC_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-crc-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8-a+crypto \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_AES_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-aes-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8-a+crypto \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_PMULL_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-pmull-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8-a+crypto \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SHA_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-sha-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8-a+crypto \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SHA1_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-sha1-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8.2-a+sha3 \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SHA512_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-sha512-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8.2-a+sha3 \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=armv8.2-a+sm4 \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SM4_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-sm4-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SIMD_PERMUTE_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-simd-permute-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SIMD_MINMAX_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-simd-minmax-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_AARCH64_SIMD_ABSDIFF_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-pcall-simd-absdiff-real.so"
  aarch64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    ...
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossneeded-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    ...
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesstls-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    ...
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesstlsdefault-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfp64-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfp64-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_NATIVE_SRET_DEP \
    -Wl,-soname,libpolyprocesscrossnativesret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossnativesret-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP64_DEP \
    -Wl,-soname,libpolyprocesscrossfp64-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfp64-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfpairarg-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfpairret-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_SRET_DEP \
    -Wl,-soname,libpolyprocesscrosssret-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrosssret-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossfp32-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfp32-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_ARG_DEP \
    -Wl,-soname,libpolyprocesscrossfpairarg-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfpairarg-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_RET_DEP \
    -Wl,-soname,libpolyprocesscrossfpairret-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfpairret-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP32_DEP \
    -Wl,-soname,libpolyprocesscrossfp32-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossfp32-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossvec-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossvec-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_VEC128_DEP \
    -Wl,-soname,libpolyprocesscrossvec-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossvec-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrosscompact-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrosscompact-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_COMPACT_DEP \
    -Wl,-soname,libpolyprocesscrosscompact-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrosscompact-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-riscv.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolyprocesscrossstack9-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-aarch64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossstack9-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_STACK9_DEP \
    -Wl,-soname,libpolyprocesscrossstack9-x86_64.so \
    -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolyprocesscrossstack9-x86_64.so"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
  ...
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossneeded-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-needed-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_STACK9_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossstack9-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-stack9-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP64_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp64-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-fp64-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp32-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-fp32-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairarg-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-fpairarg-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_RET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairret-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-fpairret-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_SRET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrosssret-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-sret-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_VEC128_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossvec-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-vec128-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_COMPACT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrosscompact-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-compact-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesstls-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-tls-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesstlsdefault-x86_64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-x86-tls-default-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
  ...
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp64-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-fp64-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FP32_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfp32-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-fp32-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_ARG_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairarg-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-fpairarg-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_FPAIR_RET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossfpairret-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-fpairret-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_SRET_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYEXEC_PROCESS_NEEDED_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossnativesret-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-sret-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_VEC128_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossvec-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-vec128-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_COMPACT_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrosscompact-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-compact-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -DPOLY_PROCESS_NEEDED_STACK9_MAIN \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    ...
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolyprocesscrossstack9-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-process-cross-stack9-real.elf"
  riscv64-linux-gnu-gcc -O2 -fno-builtin -fno-tree-vectorize -fPIC -shared \
    -nostdlib -nodefaultlibs -march=rv64gc -mabi=lp64d \
    -Wl,-e,_start -Wl,--hash-style=sysv -Wl,--build-id=none \
    -Wl,-rpath,'$ORIGIN/processdeps' \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP64_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossfp64-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossfp32-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossfp32-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossifunccompact-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossifuncfp32-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossifuncvec-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_ROOT_DEP_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/libpolycrossrootifuncfp32-riscv.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossrootifuncvec-riscv.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP64_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolycrossfp64-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossfp32-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolycrossfp32-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossifunccompact-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolycrossifuncfp32-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossifuncvec-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_FP32_ROOT_DEP_REAL_SRC" \
    -o "$TMP_DIR/poly-link/riscv/libpolycrossrootifuncfp32-aarch64.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-soname,libpolycrossrootifuncvec-aarch64.so -Wl,--hash-style=sysv \
    -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    "$POLYCALL_CROSS_FP64_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolycrossfp64-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-cross-fp64-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_FP32_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolycrossfp32-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-cross-fp32-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_COMPACT_MAIN_REAL_SRC" \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    "$POLYCALL_CROSS_IFUNC_FP32_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolycrossifuncfp32-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-cross-ifunc-fp32-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_VEC128_MAIN_REAL_SRC" \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    "$POLYCALL_CROSS_IFUNC_FP32_ROOT_MAIN_REAL_SRC" \
    -L"$TMP_DIR/poly-link/riscv" \
    -Wl,--no-as-needed -l:libpolycrossrootifuncfp32-aarch64.so \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-cross-root-ifunc-fp32-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,-E -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_CROSS_IFUNC_VEC128_ROOT_MAIN_REAL_SRC" \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    ...
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_LARGE_TLS_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-large-tls-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64g -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_LARGE_IMAGE_REAL_SRC" \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64gc_zbs -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_RISCV_ZBS_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-zbs-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64gc_zba_zbb_zicond -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64gc_zbc -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
    "$POLYCALL_RISCV_ZBC_REAL_SRC" \
    -o "$TMP_DIR/initramfs-root/usr/lib/polyapps/riscv-pcall-zbc-real.so"
  riscv64-linux-gnu-gcc -O2 -fPIC -shared -nostdlib -nodefaultlibs \
    -march=rv64gc_zkne_zknd -mabi=lp64d \
    -Wl,-e,poly_entry -Wl,--hash-style=sysv -Wl,--build-id=none \
  ...
  "$POLY_ELF_GEN_BIN" aarch64 "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-scaled-mem.elf" 0xd10403ff 0x910003f4 0xf9004fff 0x52800157 0xb9009bf7 0x390273ff 0x52824685 0x790143e5 0x39426283 0xf9404e97 0xb9409a88 0xb9809a89 0x7941428a 0x8b170060 0x8b080000 0x8b090000 0x8b0a0000 0x910403ff 0xd65f03c0
  ...
  "$POLY_ELF_GEN_BIN" aarch64 "$TMP_DIR/initramfs-root/usr/lib/polyapps/aarch64-idregs.elf" 0xd5380600 0xd5380621 0xd5380402 0xd5380423 0xd5380704 0xd5380725 0xd5380506 0xd5380447 0xd5380488 0xd53804a9 0xd538052a 0xd538064b 0xd538074c 0xd538076d 0xd538078e 0xd538000f 0xd53800b0 0xd53800d1 0xd5380592 0xd53805b3 0xaa010000 0xaa020000 0xaa030000 0xaa040000 0xaa050000 0xaa060000 0xaa070000 0xaa080000 0xaa090000 0xaa0a0000 0xaa0b0000 0xaa0c0000 0xaa0d0000 0xaa0e0000 0xaa0f0000 0xaa100000 0xaa110000 0xaa120000 0xaa130000 0xd65f03c0
...
POLY_ALPINE_POSTGRES_SETUP_TIMEOUT="$POLY_ALPINE_POSTGRES_SETUP_TIMEOUT"
...
export POLY_ALPINE_POSTGRES_SETUP_TIMEOUT
...
if [ "$RUN_POLY_NEUTRAL" = "1" ]; then
  /usr/bin/polyapp \
    ...
    /usr/lib/polyapps/aarch64-generic-switch-x86.poly \
...
if [ "$RUN_POLY_EXEC_CROSS" = "1" ]; then
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-stack9-real.elf=42 \
      cross-aarch64-to-riscv-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-stack9-real.elf=42 \
      cross-riscv-to-aarch64-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-sret-real.elf=42 \
      cross-aarch64-to-riscv-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-sret-real.elf=42 \
      cross-riscv-to-aarch64-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-fpairarg-real.elf=42 \
      cross-aarch64-to-riscv-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-fpairret-real.elf=42 \
      cross-aarch64-to-riscv-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-fpairarg-real.elf=42 \
      cross-riscv-to-aarch64-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-fpairret-real.elf=42 \
      cross-riscv-to-aarch64-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-stack9-real.elf=42 \
      cross-aarch64-to-x86-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-stack9-real.elf=42 \
      cross-riscv-to-x86-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fp64-real.elf=42 \
      cross-aarch64-to-x86-fp64 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fp32-real.elf=42 \
      cross-aarch64-to-x86-fp32 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real.elf=42 \
      cross-aarch64-to-x86-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real.elf=42 \
      cross-aarch64-to-x86-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-sret-real.elf=42 \
      cross-aarch64-to-x86-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-fp64-real.elf=42 \
      cross-riscv-to-x86-fp64 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-fp32-real.elf=42 \
      cross-riscv-to-x86-fp32 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-fpairarg-real.elf=42 \
      cross-riscv-to-x86-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-fpairret-real.elf=42 \
      cross-riscv-to-x86-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-sret-real.elf=42 \
      cross-riscv-to-x86-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-vec128-real.elf=42 \
      cross-aarch64-to-x86-vec128 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-vec128-real.elf=42 \
      cross-riscv-to-x86-vec128 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-compact-real.elf=42 \
      cross-aarch64-to-x86-compact >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-compact-real.elf=42 \
      cross-riscv-to-x86-compact >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32-real.elf=42 \
      cross-x86-to-aarch64-hfa32 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64-real.elf=42 \
      cross-x86-to-aarch64-hfa64 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32arg-real.elf=42 \
      cross-x86-to-aarch64-hfa32arg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64arg-real.elf=42 \
      cross-x86-to-aarch64-hfa64arg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-fpairarg-real.elf=42 \
      cross-x86-to-aarch64-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-fpairarg-real.elf=42 \
      cross-x86-to-riscv-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-fpairret-real.elf=42 \
      cross-x86-to-aarch64-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-fpairret-real.elf=42 \
      cross-x86-to-riscv-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-sret-real.elf=42 \
      cross-x86-to-aarch64-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-sret-real.elf=42 \
      cross-x86-to-riscv-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-stack9-real.elf=42 \
      cross-x86-to-aarch64-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-stack9-real.elf=42 \
      cross-x86-to-riscv-stack9 >/dev/ttyS0 2>&1
...
if [ "$RUN_POLY_EXEC_SYSCALL" = "1" ]; then
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-io-uring-real.elf=42 \
...
if [ "$RUN_POLY_EXEC" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-scaled-mem.elf=0x125c \
    ...
    /usr/lib/polyapps/aarch64-idregs.elf=0 \
    ...
    /usr/lib/polyapps/aarch64-bpf.elf=0xffffffffffffffff \
    ...
    /usr/lib/polyapps/riscv-bpf.elf=0xffffffffffffffff \
...
if [ "$RUN_POLY_JIT_SELFTEST" = "1" ]; then
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-jit-selfmod-real.elf=42 \
      jit-selfmod >/dev/ttyS0 2>&1
    echo "POLY_JIT_SELFTEST_OK" >/dev/ttyS0 2>&1
fi
...
if [ "$RUN_POLY_ARCH_TRAP_EXEC" = "1" ]; then
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-needed-real.elf=42 \
      cross-x86-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-stack9-real.elf=42 \
      cross-x86-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fp64-real.elf=42 \
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real.elf=42 \
      cross-x86-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real.elf=42 \
      cross-x86-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-sret-real.elf=42 \
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-tls-real.elf=42 \
      cross-x86-tls >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-x86-tls-default-real.elf=42 \
      cross-x86-tls-default >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-needed-real.elf=42 \
      x86-cross-aarch64-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-needed-real.elf=42 \
      x86-cross-riscv-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-fp64-real.elf=42 \
      x86-cross-aarch64-fp64 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-fp64-real.elf=42 \
      x86-cross-riscv-fp64 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-fp32-real.elf=42 \
      x86-cross-aarch64-fp32 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32-real.elf=42 \
      x86-cross-aarch64-hfa32 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64-real.elf=42 \
      x86-cross-aarch64-hfa64 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32arg-real.elf=42 \
      x86-cross-aarch64-hfa32arg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64arg-real.elf=42 \
      x86-cross-aarch64-hfa64arg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-fpairarg-real.elf=42 \
      x86-cross-aarch64-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-fpairarg-real.elf=42 \
      x86-cross-riscv-fpairarg >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-fpairret-real.elf=42 \
      x86-cross-aarch64-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-fpairret-real.elf=42 \
      x86-cross-riscv-fpairret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-sret-real.elf=42 \
      x86-cross-aarch64-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-sret-real.elf=42 \
      x86-cross-riscv-sret >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-fp32-real.elf=42 \
      x86-cross-riscv-fp32 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-vec128-real.elf=42 \
      x86-cross-aarch64-vec128 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-vec128-real.elf=42 \
      x86-cross-riscv-vec128 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-compact-real.elf=42 \
      x86-cross-aarch64-compact >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-compact-real.elf=42 \
      x86-cross-riscv-compact >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-stack9-real.elf=42 \
      x86-cross-aarch64-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-stack9-real.elf=42 \
      x86-cross-riscv-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-stack9-real.elf=42 \
      aarch64-cross-riscv-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-stack9-real.elf=42 \
      riscv-cross-aarch64-stack9 >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-ifunc-real.elf=42 \
      x86-cross-aarch64-ifunc >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-ifunc-real.elf=42 \
      x86-cross-riscv-ifunc >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-transitive-real.elf=42 \
      x86-cross-aarch64-transitive >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-transitive-real.elf=42 \
      x86-cross-riscv-transitive >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-indirect-real.elf=42 \
      x86-cross-aarch64-indirect >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-versioned-real.elf=42 \
      x86-cross-aarch64-versioned >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-versioned-real.elf=42 \
      x86-cross-riscv-versioned >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-weak-real.elf=42 \
      x86-cross-aarch64-weak >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-weak-real.elf=42 \
      x86-cross-riscv-weak >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-tls-real.elf=42 \
      x86-cross-aarch64-tls >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-tls-real.elf=42 \
      x86-cross-riscv-tls >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-tls-default-real.elf=42 \
      x86-cross-aarch64-tls-default >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-riscv-tls-default-real.elf=42 \
      x86-cross-riscv-tls-default >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/x86_64-process-cross-aarch64-tls-trad-real.elf=42 \
      x86-cross-aarch64-tls-trad >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
    ...
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-fp64-real.elf=42 \
      cross-fp64-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-fp32-real.elf=42 \
      cross-fp32-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-fpairarg-real.elf=42 \
      cross-fpairarg-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-fpairret-real.elf=42 \
      cross-fpairret-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-sret-real.elf=42 \
      cross-sret-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-vec128-real.elf=42 \
      cross-vec128-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/aarch64-process-cross-compact-real.elf=42 \
    ...
    /usr/bin/polyexec --process \
      ...
      cross-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-needed-real.elf=42 \
      cross-x86-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-stack9-real.elf=42 \
      cross-x86-stack9 >/dev/ttyS0 2>&1
    ...
    /usr/bin/polyexec --process \
      ...
      cross-x86-compact >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-tls-real.elf=42 \
      cross-x86-tls >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-x86-tls-default-real.elf=42 \
      cross-x86-tls-default >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
    ...
    /usr/bin/polyexec --process \
      ...
      cross-ifunc-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-fp64-real.elf=42 \
      cross-fp64-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-fp32-real.elf=42 \
      cross-fp32-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-fpairarg-real.elf=42 \
      cross-fpairarg-needed >/dev/ttyS0 2>&1
    ...
    /usr/bin/polyexec --process \
      ...
      cross-sret-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-vec128-real.elf=42 \
      cross-vec128-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
      /usr/lib/polyapps/riscv-process-cross-compact-real.elf=42 \
      cross-compact-needed >/dev/ttyS0 2>&1
    /usr/bin/polyexec --process \
...
if [ "$RUN_POLY_CALL" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-pcall-getauxval-real.so#poly_entry=10579 \
    ...
    /usr/lib/polyapps/aarch64-pcall-snprintf-fp-real.so#poly_entry=1155 \
    ...
    /usr/lib/polyapps/aarch64-pcall-cross-fp64-real.so#poly_entry=0x4026800000000000 \
    /usr/lib/polyapps/aarch64-pcall-cross-fp32-real.so#poly_entry=0x41340000 \
    /usr/lib/polyapps/aarch64-pcall-cross-ifunc-fp64-stack-real.so#poly_entry=0x4061100000000000 \
    /usr/lib/polyapps/aarch64-pcall-cross-ifunc-fp32-real.so#poly_entry=0x41340000 \
    ...
    /usr/lib/polyapps/aarch64-pcall-cross-root-ifunc-fp32-real.so#poly_entry=0x41340000 \
    ...
    /usr/lib/polyapps/aarch64-pcall-crc-real.so#poly_entry=42 \
    /usr/lib/polyapps/aarch64-pcall-aes-real.so#poly_entry=42 \
    /usr/lib/polyapps/aarch64-pcall-pmull-real.so#poly_entry=42 \
    /usr/lib/polyapps/aarch64-pcall-sha-real.so#poly_entry=42 \
    ...
    /usr/lib/polyapps/aarch64-pcall-simd-minmax-real.so#poly_entry=42 \
    /usr/lib/polyapps/aarch64-pcall-simd-absdiff-real.so#poly_entry=42 \
    ...
    /usr/lib/polyapps/riscv-pcall-getauxval-real.so#poly_entry=12669 \
    ...
    /usr/lib/polyapps/riscv-pcall-snprintf-fp-real.so#poly_entry=1155 \
    ...
    /usr/lib/polyapps/riscv-pcall-cross-fp64-real.so#poly_entry=0x4026800000000000 \
    /usr/lib/polyapps/riscv-pcall-cross-fp32-real.so#poly_entry=0x41340000 \
    /usr/lib/polyapps/riscv-pcall-cross-ifunc-fp64-stack-real.so#poly_entry=0x4061100000000000 \
    /usr/lib/polyapps/riscv-pcall-cross-ifunc-fp32-real.so#poly_entry=0x41340000 \
    ...
    /usr/lib/polyapps/riscv-pcall-cross-root-ifunc-fp32-real.so#poly_entry=0x41340000 \
...
if [ "$RUN_POLY_BINFMT" = "1" ]; then
  ...
  if [ "$RUN_POLY_BINFMT_ARCH_TRAPS" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-process-needed-transitive-real.elf \
      transitive-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process transitive needed" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-needed-indirect-real.elf \
      indirect-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process indirect needed" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-needed-ifunc-real.elf \
      ifunc-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process ifunc needed" >/dev/ttyS0
      exit 1
    }
    POLY_LD_PRELOAD=/usr/lib/polyapps/libpolyprocesspreload-aarch64.so \
    ...
    /usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real.elf \
      cross-x86-fpairarg >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process cross x86 fpairarg" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real.elf \
      cross-x86-fpairret >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process cross x86 fpairret" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/aarch64-process-cross-fp32-real.elf \
      cross-fp32-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process cross fp32" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-cross-fpairarg-real.elf \
      cross-fpairarg-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process cross fpairarg" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-cross-fpairret-real.elf \
      cross-fpairret-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process cross fpairret" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-cross-sret-real.elf \
      cross-sret-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process cross sret" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/aarch64-process-tls-default-real.elf \
      tls-default >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process default tls" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/aarch64-process-tls-trad-real.elf \
      tls-trad >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process traditional tls" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/aarch64-process-tls-trad-needed-real.elf \
      tls-trad-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: aarch64 direct process dependency traditional tls" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/riscv-process-needed-transitive-real.elf \
      transitive-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process transitive needed" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/riscv-process-needed-indirect-real.elf \
      indirect-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process indirect needed" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/riscv-process-needed-ifunc-real.elf \
      ifunc-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process ifunc needed" >/dev/ttyS0
      exit 1
    }
    POLY_LD_PRELOAD=/usr/lib/polyapps/libpolyprocesspreload-riscv.so \
    ...
    /usr/lib/polyapps/riscv-process-cross-x86-fpairarg-real.elf \
      cross-x86-fpairarg >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross x86 fpairarg" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/riscv-process-cross-x86-fpairret-real.elf \
      cross-x86-fpairret >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross x86 fpairret" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/riscv-process-cross-x86-compact-real.elf \
      cross-x86-compact >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross x86 compact" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/riscv-process-cross-fp32-real.elf \
      cross-fp32-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross fp32" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/riscv-process-cross-fpairarg-real.elf \
      cross-fpairarg-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross fpairarg" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/riscv-process-cross-fpairret-real.elf \
      cross-fpairret-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross fpairret" >/dev/ttyS0
      exit 1
    }
    /usr/lib/polyapps/riscv-process-cross-sret-real.elf \
      cross-sret-needed >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process cross sret" >/dev/ttyS0
      exit 1
    }
    ...
    /usr/lib/polyapps/riscv-process-tls-default-real.elf \
      tls-default >/dev/ttyS0 2>&1 || {
      echo "POLYBINFMT_FAIL: riscv direct process default tls" >/dev/ttyS0
      exit 1
    }
    ...
    for foreign in \
      ...
      /usr/lib/polyapps/aarch64-scaled-mem.elf \
      ...
      /usr/lib/polyapps/aarch64-idregs.elf \
...
if [ "$RUN_POLY_ALPINE_POSTGRES_SMOKE" = "1" ]; then
  ...
  echo "POLY_ALPINE_POSTGRES_SMOKE_CMD: initdb postgres pgbench" \
    >/dev/ttyS0
  /bin/busybox timeout "\$POLY_ALPINE_POSTGRES_SETUP_TIMEOUT" \
    /usr/bin/polycontainer-run /oci-alpine-arm64 /bin/sh -c '
      set -eu
      PATH=/usr/libexec/postgresql18:/usr/bin:/bin:/usr/sbin:/sbin
      echo POLY_ALPINE_POSTGRES_SETUP_STEP: addgroup
      addgroup -S -g 70 postgres || true
      echo POLY_ALPINE_POSTGRES_SETUP_STEP: adduser
      adduser -S -D -H -u 70 -h /tmp/postgres -s /bin/sh -G postgres postgres || true
      echo POLY_ALPINE_POSTGRES_SETUP_STEP: mkdir
      mkdir -p /tmp/postgres /tmp/pgdata /tmp/pgrun
      echo POLY_ALPINE_POSTGRES_SETUP_STEP: chown
      chown -R postgres:postgres /tmp/postgres /tmp/pgdata /tmp/pgrun
      echo POLY_ALPINE_POSTGRES_SETUP_STEP: sentinel
      : > /tmp/postgres/user.poly
      chmod 666 /tmp/postgres/user.poly
      echo POLY_ALPINE_POSTGRES_SETUP_OK
    ' >/dev/ttyS0 2>&1 || {
  ...
  while true; do
    ...
    if grep -q "BOOT_OK: initramfs reached userspace" "$SERIAL_LOG"; then
      ...
      if [[ "$RUN_POLY_NEUTRAL" == "1" ]]; then
        ...
        if ! grep -Eq "POLYAPP_RESULT: arch=aarch64 value=45 path=/usr/lib/polyapps/aarch64-generic-switch-riscv\\.poly final_arch=riscv switch_delta=3" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYAPP_RESULT: arch=aarch64 value=45 path=/usr/lib/polyapps/aarch64-generic-switch-x86\\.poly final_arch=x86 switch_delta=2" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYAPP_RESULT: arch=riscv value=45 path=/usr/lib/polyapps/riscv-generic-call-aarch64\\.poly final_arch=riscv switch_delta=4" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYAPP_RESULT: arch=riscv value=45 path=/usr/lib/polyapps/riscv-generic-switch-aarch64\\.poly final_arch=aarch64 switch_delta=3" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYAPP_RESULT: arch=riscv value=45 path=/usr/lib/polyapps/riscv-generic-switch-x86\\.poly final_arch=x86 switch_delta=2" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
      fi
      if [[ "$RUN_POLY_EXEC_CROSS" == "1" ]]; then
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-stack9-real\\.elf.*stack_bridges=[1-9][0-9]*" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-stack9-real\\.elf.*stack_bridges=[1-9][0-9]*.*x86_wrappers=[1-9][0-9]*" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-stack9-real\\.elf.*stack_bridges=[1-9][0-9]*.*x86_wrappers=[1-9][0-9]*" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-fp64-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-fp32-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-sret-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-fp64-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-fp32-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-sret-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-vec128-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-vec128-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-compact-real\\.elf.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-compact-real\\.elf.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-stack9-real\\.elf.*stack_bridges=[1-9][0-9]*" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-stack9-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-stack9-real\\.elf.*stack_bridges=[1-9][0-9]*" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
      fi
      if [[ "$RUN_POLY_EXEC_SYSCALL" == "1" ]]; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-io-uring-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-io-uring-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if [[ "$(grep -c "POLY_IO_URING_NOP_OK" "$SERIAL_LOG" || true)" -lt 2 ]]; then
          sleep 1
          continue
        fi
      ...
      if [[ "$RUN_POLY_JIT_SELFTEST" == "1" ]]; then
        if ! grep -q "POLY_JIT_SELFTEST_OK" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -q "POLY_JIT_SELF_MOD_OK: arch=aarch64 first=13 second=29 wx=1 icache=1" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-jit-selfmod-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
      fi
      ...
      if [[ "${RUN_POLY_EXEC_PROCESS_DETAIL_ASSERTS:-0}" == "1" ]]; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-needed-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-needed-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-stack9-real\\.elf" "$SERIAL_LOG"; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-x86-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-needed-real\\.elf" "$SERIAL_LOG"; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32arg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa32arg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64arg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-hfa64arg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-sret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-stack9-real\\.elf" "$SERIAL_LOG"; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-ifunc-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-ifunc-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-ifunc-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-ifunc-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-transitive-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-transitive-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-transitive-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-transitive-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-indirect-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-indirect-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-indirect-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-versioned-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-versioned-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-versioned-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-versioned-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-weak-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-weak-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-weak-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-weak-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-riscv-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-riscv-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=x86_64 value=42 process=1 path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-trad-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*x86_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-trad-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        polyexec_x86_root_bridge_patterns=(
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fp64-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          ...
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-fp32-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-vec128-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-vec128-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-compact-real\\.elf.*sig_slots=[1-9][0-9]*.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-compact-real\\.elf.*sig_slots=[1-9][0-9]*.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-tls-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-default-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-tls-default-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-tls-trad-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-ifunc-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-ifunc-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-transitive-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-transitive-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-indirect-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-riscv-indirect-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/x86_64-process-cross-aarch64-versioned-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-fp64-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-fp32-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-fpairarg-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-fpairret-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-sret-real\\.elf" "$SERIAL_LOG"; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-vec128-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=aarch64 value=42 process=1 path=/usr/lib/polyapps/aarch64-process-cross-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-compact-real\\.elf.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-needed-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-needed-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-stack9-real\\.elf" "$SERIAL_LOG"; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-tls-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-x86-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-tls-default-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        polyexec_foreign_x86_bridge_patterns=(
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          ...
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-fp64-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-fp64-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-fp32-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-fp32-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-vec128-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-vec128-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-compact-real\\.elf.*sig_slots=[1-9][0-9]*.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-compact-real\\.elf.*sig_slots=[1-9][0-9]*.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-tls-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-tls-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/aarch64-process-cross-x86-tls-default-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-x86-tls-default-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
        )
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fp64-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-fp64-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fp32-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-fp32-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fpairarg-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-fpairarg-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fpairret-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-fpairret-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-sret-real\\.elf" "$SERIAL_LOG"; then
        ...
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-vec128-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-vec128-real\\.elf.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_RESULT: arch=riscv value=42 process=1 path=/usr/lib/polyapps/riscv-process-cross-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-compact-real\\.elf" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYEXEC_CROSS_STUBS: .*path=/usr/lib/polyapps/riscv-process-cross-compact-real\\.elf.*stack_bridges=0.*compact_shuffles=[1-9][0-9]*.*x86_wrappers=0" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
      ...
      if [[ "$RUN_POLY_CALL" == "1" ]]; then
        ...
        if ! grep -Eq "POLYCALL_X86_IMPORT_STUBS: arch=aarch64 .*direct_sigregs=[1-9].*thunks=0 .*aarch64-pcall-x86-fp32-import-real\\.so" "$SERIAL_LOG" ||
            ! grep -Eq "POLYCALL_RESULT_FP32: arch=aarch64 .*aarch64-pcall-x86-fp32-import-real\\.so" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYCALL_X86_IMPORT_STUBS: arch=riscv .*direct_sigregs=[1-9].*thunks=0 .*riscv-pcall-x86-fp32-import-real\\.so" "$SERIAL_LOG" ||
            ! grep -Eq "POLYCALL_RESULT_FP32: arch=riscv .*riscv-pcall-x86-fp32-import-real\\.so" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        ...
        if ! grep -Eq "POLYCALL_ROOT_PCALL: arch=aarch64 exchange_u64=0 call_kind=23 .*special_sig=1 .*sret_thunk=0 .*fp64_stack_thunk=0 .*hfa_f64_arg_thunk=0 .*hfa_f64_ret_thunk=1 .*hfa_f32_ret_thunk=0 .*aarch64-pcall-hfa3-real\\.so" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYCALL_ROOT_PCALL: arch=aarch64 exchange_u64=0 call_kind=24 .*special_sig=1 .*sret_thunk=0 .*fp64_stack_thunk=0 .*hfa_f64_arg_thunk=0 .*hfa_f64_ret_thunk=1 .*hfa_f32_ret_thunk=0 .*aarch64-pcall-hfa4-real\\.so" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYCALL_ROOT_PCALL: arch=aarch64 exchange_u64=0 call_kind=27 .*special_sig=0 .*sret_thunk=0 .*fp64_stack_thunk=0 .*hfa_f64_arg_thunk=1 .*hfa_f64_ret_thunk=0 .*hfa_f32_ret_thunk=0 .*aarch64-pcall-hfa-arg-real\\.so" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
        if ! grep -Eq "POLYCALL_ROOT_PCALL: arch=aarch64 exchange_u64=0 call_kind=28 .*special_sig=0 .*sret_thunk=0 .*fp64_stack_thunk=0 .*hfa_f64_arg_thunk=1 .*hfa_f64_ret_thunk=0 .*hfa_f32_ret_thunk=0 .*aarch64-pcall-hfa-arg-real\\.so" "$SERIAL_LOG"; then
          sleep 1
          continue
        fi
      ...
      if [[ "$RUN_POLY_BENCH" == "1" ]]; then
        ...
        polybench_patterns=(
          ...
          "POLYBENCH_TRAP_DENSITY_RESULT: arch=aarch64 .*monitor_traps=0 traps_per_million=0"
          "POLYBENCH_TRAP_DENSITY_RESULT: arch=riscv .*monitor_traps=0 traps_per_million=0"
          "POLYBENCH_TRAP_DENSITY_RESULT: arch=riscv-compressed .*monitor_traps=0 traps_per_million=0"
          "POLYBENCH_MIXED_RESULT: direction=aarch64-to-riscv .*switch_delta=[0-3]"
          "POLYBENCH_MIXED_RESULT: direction=aarch64-to-compressed-riscv .*switch_delta=[0-3]"
          "POLYBENCH_MIXED_RESULT: direction=riscv-to-aarch64 .*switch_delta=[0-3]"
          "POLYBENCH_MIXED_RESULT: direction=riscv-compressed-to-aarch64 .*switch_delta=[0-3]"
          ...
          "POLYBENCH_CROSS_CALL_RESULT: direction=compressed-riscv-calls-aarch64 .*switch_delta=5"
          "POLYBENCH_NEUTRAL_PCALL_RESULT: direction=x86-wrapped-aarch64-calls-riscv .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_RESULT: direction=x86-wrapped-riscv-calls-aarch64 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_RESULT: direction=x86-wrapped-compressed-riscv-calls-aarch64 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_FP64_RESULT: direction=x86-wrapped-aarch64-calls-riscv-fp64 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_FP64_RESULT: direction=x86-wrapped-riscv-calls-aarch64-fp64 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_FP64_RESULT: direction=x86-wrapped-compressed-riscv-calls-aarch64-fp64 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_FP32_RESULT: direction=x86-wrapped-aarch64-calls-riscv-fp32 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_FP32_RESULT: direction=x86-wrapped-riscv-calls-aarch64-fp32 .*switch_delta=3.*inner_switch_delta=2"
          "POLYBENCH_NEUTRAL_PCALL_FP32_RESULT: direction=x86-wrapped-compressed-riscv-calls-aarch64-fp32 .*switch_delta=3.*inner_switch_delta=2"
          ...
          "POLYBENCH_DIRECT_X86_PCALL_RESULT: direction=compressed-riscv-calls-x86-direct .*switch_delta=5"
          "POLYBENCH_DIRECT_X86_SRET_RESULT: direction=aarch64-calls-x86-direct-sret .*switch_delta=5"
          "POLYBENCH_DIRECT_X86_SRET_RESULT: direction=riscv-calls-x86-direct-sret .*switch_delta=5"
          "POLYBENCH_DIRECT_X86_SRET_RESULT: direction=compressed-riscv-calls-x86-direct-sret .*switch_delta=5"
          ...
          "POLYBENCH_DIRECT_X86_FP64_RESULT: direction=compressed-riscv-calls-x86-direct-fp64 .*switch_delta=5"
          ...
          "POLYBENCH_DIRECT_X86_FP32_RESULT: direction=compressed-riscv-calls-x86-direct-fp32 .*switch_delta=5"
          "POLYBENCH_DIRECT_X86_VEC128_RESULT: direction=aarch64-calls-x86-direct-vec128 .*switch_delta=5"
          "POLYBENCH_DIRECT_X86_VEC128_RESULT: direction=riscv-calls-x86-direct-vec128 .*switch_delta=5"
          "POLYBENCH_DIRECT_X86_VEC128_RESULT: direction=compressed-riscv-calls-x86-direct-vec128 .*switch_delta=5"
          "POLYBENCH_X86_PCALL_SIGNATURE_RESULT: direction=x86-calls-aarch64-signature .*switch_delta=2"
          "POLYBENCH_X86_PCALL_SIGNATURE_RESULT: direction=x86-calls-riscv-signature .*switch_delta=2"
          "POLYBENCH_X86_PCALL_FP64_SIGNATURE_RESULT: direction=x86-calls-aarch64-fp64-signature .*switch_delta=2"
          ...
          "POLYBENCH_CROSS_CALL_FP_RESULT: direction=compressed-riscv-calls-aarch64-fp .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_FP64_STACK_RESULT: direction=compressed-riscv-calls-aarch64-fp64-stack .*switch_delta=5"
          "POLYBENCH_CROSS_CALL_VEC128_RESULT: direction=aarch64-calls-riscv-vec128 .*switch_delta=3"
          "POLYBENCH_CROSS_CALL_VEC128_RESULT: direction=riscv-calls-aarch64-vec128 .*switch_delta=3"
          "POLYBENCH_CROSS_CALL_VEC128_RESULT: direction=compressed-riscv-calls-aarch64-vec128 .*switch_delta=3"
          ...
          "POLYBENCH_CROSS_CALL_MIXED_RESULT: direction=compressed-riscv-calls-aarch64-mixed .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_STACK_RESULT: direction=compressed-riscv-calls-aarch64-stack .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_SAVED_RESULT: direction=compressed-riscv-calls-aarch64-saved .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_SAVED_FP_RESULT: direction=compressed-riscv-calls-aarch64-saved-fp .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_PAIR_RESULT: direction=compressed-riscv-calls-aarch64-pair .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_SYSCALL_RESULT: direction=compressed-riscv-calls-aarch64-syscall .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_BREAK_RESULT: direction=compressed-riscv-calls-aarch64-break .*switch_delta=5"
          ...
          "POLYBENCH_CROSS_CALL_DIRECT_X86_MEMCMP_RESULT: direction=compressed-riscv-calls-aarch64-direct-x86-memcmp .*switch_delta=7"
          ...
          "POLYBENCH_CROSS_CALL_DIRECT_X86_MEMOPS_RESULT: direction=compressed-riscv-calls-aarch64-direct-x86-memops .*switch_delta=11"
        )
      ...
      if [[ "$RUN_POLY_BINFMT" == "1" ]]; then
        ...
        polybinfmt_process_patterns=(
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-needed-transitive-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-needed-indirect-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-needed-ifunc-real\\.elf .*process=1"
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real\\.elf .*process=1"
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-cross-fp32-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-cross-fpairarg-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-cross-fpairret-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-cross-sret-real\\.elf .*process=1"
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/aarch64-process-tls-default-real\\.elf .*process=1"
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-needed-transitive-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-needed-indirect-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-needed-ifunc-real\\.elf .*process=1"
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-cross-x86-fpairarg-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-cross-x86-fpairret-real\\.elf .*process=1"
          ...
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-cross-fp32-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-cross-fpairarg-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-cross-fpairret-real\\.elf .*process=1"
          "POLYBINFMT_EXEC: path=/usr/lib/polyapps/riscv-process-cross-sret-real\\.elf .*process=1"
        ...
        polybinfmt_bridge_patterns=(
          "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fp64-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fp32-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*a64_to_rv=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          ...
          "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*a64_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/aarch64-process-cross-x86-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          ...
          "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-needed-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fp64-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fp32-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*rv_to_a64=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-sret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          ...
          "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-fpairarg-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
          "POLYEXEC_CROSS_STUBS: .*rv_to_x86=[1-9][0-9]*.*path=/usr/lib/polyapps/riscv-process-cross-x86-fpairret-real\\.elf.*sig_slots=[1-9][0-9]*.*reg_sig=[1-9][0-9]*.*stack_bridges=0.*x86_wrappers=0"
        ...
        for pattern in "${polybinfmt_bridge_patterns[@]}"; do
          if ! grep -Eq "$pattern" "$SERIAL_LOG"; then
            sleep 1
            continue 2
          fi
      ...
      if [[ "$RUN_NATIVE_CHECK" == "1" ]]; then
        if [[ "$EXPECT_POLY_CPUID" == "1" ]]; then
          native_markers=(
            ...
            "NATIVE_POLY_GENERIC_SWITCH_X86_OK"
            "NATIVE_POLY_TRAP_VECTOR_OK"
            "NATIVE_POLY_THUNK_IMPORT_TRAPS_OK"
            "NATIVE_POLY_NO_VECTOR_SIGNALS_OK"
            "NATIVE_POLY_INVALID_GENERIC_CONTROLS_OK"
            "NATIVE_POLY_LEGACY_ENVELOPES_REJECTED_OK"
            "NATIVE_POLY_CPUID_ARCH_STATE_OK"
            "NATIVE_POLY_LANDING_POLICY_OK"
            "NATIVE_POLY_MEMORY_ORDERING_OK"
            "NATIVE_POLY_V2_DEBUG_NOTE_OK"
            "NATIVE_POLY_V2_MEM_PROBE_RANGE_OK"
            "NATIVE_POLY_V2_DERIVE_STATE_OK"
            "NATIVE_POLY_INVALID_PCALL_NO_MUTATION_OK"
