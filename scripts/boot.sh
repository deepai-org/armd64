...
if [ "$RUN_POLY_CALL" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-pcall-needed-real.so#poly_entry=155 \
    depfini:/usr/lib/polyapps/aarch64-pcall-needed-real.so#poly_entry=100 \
    ...
    /usr/lib/polyapps/riscv-pcall-needed-real.so#poly_entry=155 \
    depfini:/usr/lib/polyapps/riscv-pcall-needed-real.so#poly_entry=100 \
