    ...
    if grep -q "BOOT_OK: initramfs reached userspace" "$SERIAL_LOG"; then
      ...
      if [[ "$RUN_POLY_BENCH" == "1" ]]; then
        ...
        polybench_patterns=(
          ...
          "POLYBENCH_MIXED_RESULT: direction=aarch64-to-riscv .*switch_delta=3"
          "POLYBENCH_MIXED_RESULT: direction=aarch64-to-compressed-riscv .*switch_delta=3"
          "POLYBENCH_MIXED_RESULT: direction=riscv-to-aarch64 .*switch_delta=3"
          "POLYBENCH_MIXED_RESULT: direction=riscv-compressed-to-aarch64 .*switch_delta=3"
