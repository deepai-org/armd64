...
if [ "$RUN_POLY_CALL" = "1" ]; then
    ...
    fp64stack:/usr/lib/polyapps/aarch64-pcall-fp64-stack-real.so#poly_entry=0x404bc00000000000 \
    ...
    fp64stack:/usr/lib/polyapps/riscv-pcall-fp64-stack-real.so#poly_entry=0x404bc00000000000 \
