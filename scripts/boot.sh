...
POLY_IMPORT_ID_CHECK="$ROOT_DIR/tools/contracts/check_poly_import_ids.sh"
POLY_ARCH_CONTRACT_CHECK="$ROOT_DIR/tools/contracts/check_poly_arch_contract.sh"
POLY_CPUID_CONTRACT_CHECK="$ROOT_DIR/tools/contracts/check_poly_cpuid_contract.sh"
