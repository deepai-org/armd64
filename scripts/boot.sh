...
if [ "$RUN_POLY_CALL" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-pcall-atomic.so#poly_entry=518 \
    /usr/lib/polyapps/aarch64-pcall-atomic-outline.so#poly_entry=518 \
    /usr/lib/polyapps/aarch64-pcall-atomic-lse.so#poly_entry=518 \
