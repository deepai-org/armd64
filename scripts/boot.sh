...
if [ "$RUN_POLY_CALL" = "1" ]; then
    ...
    /usr/lib/polyapps/aarch64-pcall-cross-fp64-real.so#poly_entry=0x400b000000000000 \
    ...
    /usr/lib/polyapps/riscv-pcall-cross-fp64-real.so#poly_entry=0x400b000000000000 \
