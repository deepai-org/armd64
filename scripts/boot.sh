...
POLY_ARCH_CONTRACT_CHECK="$ROOT_DIR/tools/check_poly_arch_contract.sh"
POLY_CPUID_CONTRACT_CHECK="$ROOT_DIR/tools/check_poly_cpuid_contract.sh"
...
POLYEXEC_PROCESS_SYSCALL_REAL_SRC="$ROOT_DIR/tools/polyexec_process_syscall_real.c"
POLYEXEC_PROCESS_RELOC_REAL_SRC="$ROOT_DIR/tools/polyexec_process_reloc_real.c"
...
POLYCALL_GNU_UNIQUE_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_gnu_unique_dep_real.S"
POLYCALL_GNU_UNIQUE_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_gnu_unique_main_real.c"
...
POLYCALL_CXX_FINALIZE_REAL_SRC="$ROOT_DIR/tools/polycall_cxx_finalize_real.cc"
...
POLYCALL_CROSS_IFUNC_COMPACT_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_compact_dep_real.c"
POLYCALL_CROSS_IFUNC_COMPACT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_compact_main_real.c"
POLYCALL_CROSS_IFUNC_COMPACT_ROOT_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_compact_root_dep_real.c"
POLYCALL_CROSS_IFUNC_COMPACT_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_compact_root_main_real.c"
POLYCALL_CROSS_IFUNC_FP64_STACK_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_fp64_stack_dep_real.c"
POLYCALL_CROSS_IFUNC_FP64_STACK_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_fp64_stack_main_real.c"
POLYCALL_CROSS_IFUNC_FP64_STACK_ROOT_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_fp64_stack_root_dep_real.c"
POLYCALL_CROSS_IFUNC_FP64_STACK_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_fp64_stack_root_main_real.c"
POLYCALL_CROSS_IFUNC_VEC128_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_vec128_dep_real.c"
POLYCALL_CROSS_IFUNC_VEC128_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_vec128_main_real.c"
POLYCALL_CROSS_IFUNC_VEC128_ROOT_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_vec128_root_dep_real.c"
POLYCALL_CROSS_IFUNC_VEC128_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_ifunc_vec128_root_main_real.c"
POLYCALL_CROSS_COMPACT_ROOT_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_compact_root_dep_real.c"
POLYCALL_CROSS_COMPACT_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_compact_root_main_real.c"
...
POLYCALL_CROSS_FP64_STACK_ROOT_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_cross_fp64_stack_root_dep_real.c"
POLYCALL_CROSS_FP64_STACK_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_fp64_stack_root_main_real.c"
...
POLYCALL_CROSS_VEC128_ROOT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_cross_vec128_root_main_real.c"
...
POLYCALL_RPATH_INHERIT_LEAF_REAL_SRC="$ROOT_DIR/tools/polycall_rpath_inherit_leaf_real.c"
POLYCALL_RPATH_INHERIT_MID_REAL_SRC="$ROOT_DIR/tools/polycall_rpath_inherit_mid_real.c"
POLYCALL_RPATH_INHERIT_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_rpath_inherit_main_real.c"
POLYCALL_SONAME_ONCE_LEAF_REAL_SRC="$ROOT_DIR/tools/polycall_soname_once_leaf_real.c"
POLYCALL_SONAME_ONCE_DEP_A_REAL_SRC="$ROOT_DIR/tools/polycall_soname_once_dep_a_real.c"
POLYCALL_SONAME_ONCE_DEP_B_REAL_SRC="$ROOT_DIR/tools/polycall_soname_once_dep_b_real.c"
POLYCALL_SONAME_ONCE_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_soname_once_main_real.c"
...
POLYCALL_ROOT_IFUNC_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_root_ifunc_dep_real.c"
POLYCALL_ROOT_IFUNC_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_root_ifunc_main_real.c"
POLYCALL_ROOT_WEAK_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_root_weak_dep_real.c"
POLYCALL_ROOT_WEAK_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_root_weak_main_real.c"
...
POLYCALL_VERSIONED_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_versioned_dep_real.c"
POLYCALL_VERSIONED_MAIN_REAL_SRC="$ROOT_DIR/tools/polycall_versioned_main_real.c"
POLYCALL_VERSIONED_DEP_REAL_MAP="$ROOT_DIR/tools/polycall_versioned_dep_real.map"
POLYCALL_NEEDED_IFUNC_DEP_REAL_SRC="$ROOT_DIR/tools/polycall_needed_ifunc_dep_real.c"
...
POLYCALL_DT_INIT_REAL_SRC="$ROOT_DIR/tools/polycall_dt_init_real.c"
...
POLYCALL_HFA3_REAL_SRC="$ROOT_DIR/tools/polycall_hfa3_real.c"
...
POLYCALL_X86_FP64_CALLEE_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_fp64_callee_import_real.c"
POLYCALL_X86_FP64_CALLEE_STACK_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_fp64_callee_stack_import_real.c"
POLYCALL_X86_FPAIR64_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_fpair64_import_real.c"
POLYCALL_X86_FPAIR64_FP64_CALLEE_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_fpair64_fp64_callee_import_real.c"
...
POLYCALL_X86_SRET_CALLEE_STACK_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_sret_callee_stack_import_real.c"
POLYCALL_X86_SRET_FP64_CALLEE_STACK_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_sret_fp64_callee_stack_import_real.c"
POLYCALL_X86_MIXED_U64_FP64_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_mixed_u64_fp64_import_real.c"
POLYCALL_X86_MIXED_U64_FP64_CALLEE_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_mixed_u64_fp64_callee_import_real.c"
...
POLYCALL_X86_SUM10_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_sum10_import_real.c"
POLYCALL_X86_SUM14_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_sum14_import_real.c"
POLYCALL_X86_ALIGN14_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_align14_import_real.c"
POLYCALL_X86_I128_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_i128_import_real.c"
POLYCALL_X86_I128_CALLEE_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_i128_callee_import_real.c"
POLYCALL_X86_CALLEE_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_callee_import_real.c"
POLYCALL_X86_CALLEE_STACK_IMPORT_REAL_SRC="$ROOT_DIR/tools/polycall_x86_callee_stack_import_real.c"
