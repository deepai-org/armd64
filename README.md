...
`memmove`, `memset`, `memcmp`, `memchr`, `strchr`, and `strrchr` through PLT/GOT descriptors, compiler-built imported-object
...
`memcmp`, `memchr`, `strchr`, and `strrchr`, and teardown
before returning.
