...
`memmove`, `memset`, `memcmp`, `memchr`, `strchr`, `strrchr`, and `strstr` through PLT/GOT descriptors, compiler-built imported-object
...
`memcmp`, `memchr`, `strchr`, `strrchr`, and `strstr`, and teardown
before returning.
