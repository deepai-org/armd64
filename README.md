...
| `0x40000002, subleaf 2` | `EAX=106`, `EBX=7`, `ECX=16`, `EDX=16` | Reports the first prototype foreign-to-x86 import descriptor slot id, slot count, descriptor byte size, and import-call stride. |
...
`poly_import_x86_fp64_add`, `poly_import_x86_fp64_sum8`, and
`poly_import_x86_fp32_add` descriptors enter
...
FP argument register, synthesize an x86 return address to the dedicated `0f 24` `PIRET`,
