...
`stpcpy`, and `stpncpy` through PLT/GOT descriptors, compiler-built imported-object
...
`strnlen`, `strcat`, `strncat`, `strspn`, `strcspn`, `strpbrk`, `stpcpy`, and
`stpncpy`, and teardown
before returning.
