...
`memmove`, `memset`, `memcmp`, `memchr`, `strchr`, `strrchr`, `strstr`, and `strcpy` through PLT/GOT descriptors, compiler-built imported-object
...
`memcmp`, `memchr`, `strchr`, `strrchr`, `strstr`, and `strcpy`, and teardown
before returning.
