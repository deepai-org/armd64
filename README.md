...
libgcc bit helpers `__clzdi2`, `__ctzdi2`, `__paritydi2`, and `__popcountdi2`.
For libc string/memory helpers, the OS-sensitive
environment/allocation/teardown/process-query class, and these scalar libgcc
bit helpers, a software-supplied descriptor is now required; Bochs no longer
