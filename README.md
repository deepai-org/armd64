...
`stpcpy`, `stpncpy`, `mempcpy`, `rawmemchr`, and `strchrnul` through PLT/GOT descriptors, compiler-built imported-object
...
`stpncpy`, `mempcpy`, `rawmemchr`, and `strchrnul`, and teardown
before returning.
