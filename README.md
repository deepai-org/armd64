...
`memmove`, `memset`, `memcmp`, `memchr`, `strchr`, `strrchr`, `strstr`, `strcpy`, and `strncpy` through PLT/GOT descriptors, compiler-built imported-object
...
`memcmp`, `memchr`, `strchr`, `strrchr`, `strstr`, `strcpy`, and `strncpy`, and teardown
before returning.
