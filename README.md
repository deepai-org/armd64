...
rg -a 'BOOT_OK|NATIVE_POLY_REAL_XSAVE_OK|POLY_NEUTRAL_OK|POLY_EXEC_CROSS_OK|POLY_EXEC_SYSCALL_OK|POLYTHREAD_REAL_XSAVE_CONTEXT_OK|POLYSIGNAL_REAL_XSAVE_CONTEXT_OK|POLYBENCH_OK|POLYBINFMT_OK|FAIL|Kernel panic|Oops' out/serial.log
```
