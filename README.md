...
`strncpy`, `strnlen`, `strcat`, `strncat`, `strspn`, `strcspn`, and `strpbrk`
through PLT/GOT descriptors, compiler-built imported-object
...
`strnlen`, `strcat`, `strncat`, `strspn`, `strcspn`, and `strpbrk`, and teardown
before returning.
