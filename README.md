...
generic `jalr`, RV64 word arithmetic, RISC-V compare/register-shift forms,
generic byte/halfword/word/dword raw AArch64 and RISC-V load-store forms,
syscall, and libcall forms listed above, plus native escapes.
