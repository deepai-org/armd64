...
- AArch64 HFA-of-float returns and HFA-of-float arguments use precise
  register-only signature features. HFA-of-double returns and HFA arguments
  that are stack-backed on the source ABI still use thunks because they require
